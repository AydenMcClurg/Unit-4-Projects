...
function init() {
   ...
   //displays incorrect and correct words if found any
...
//changes color of letter if its correct
...
//so you can continue to move the mouse to a word
...
//when you let go of the mouse after dragging it this function will check if the word is correct
